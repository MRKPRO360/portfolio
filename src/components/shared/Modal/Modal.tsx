...
function Modal({ setIsModalOpen, confirmDelete, closeModal }: IModal) {
  return (
    <div
      onClick={closeModal}
      id="modal-overlay"
      className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center p-4 text-textGray backdrop-blur-sm"
    >
      <div className="bg-textGreen p-6 rounded-lg shadow-lg max-w-sm w-full text-center">
        <h2 className="text-lg font-bold">Confirm Deletion</h2>
        <p className=" mt-2">Are you sure you want to delete this post?</p>
        <div className="mt-4 flex justify-center text-lg font-semibold space-x-4">
          <button
